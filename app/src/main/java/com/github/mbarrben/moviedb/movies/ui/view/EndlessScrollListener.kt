...
abstract class EndlessScrollListener(
    ...
    private val visibleThreshold: Int = when (layoutManager) {
        ...
        else -> throw IllegalArgumentException("layout manager $layoutManager not supported. Only LinearLayoutManager, GridLayoutManager and StaggeredGridLayoutManager are supported")
    }
    ...
    private fun RecyclerView.LayoutManager.findLastVisibleItemPosition() = when (layoutManager) {
